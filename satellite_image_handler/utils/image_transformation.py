...
class PolygoneBoundariesImage:
    ...
    def __init__(self, wkt_polygone, get_row_col_index_from_longitide_latitude):
        """
        Initialize the PolygoneBoundariesImage object with the specified polygon boundaries
        and coordinate mapping function.
        ...
        self.get_row_col_index_from_longitide_latitude = (
            get_row_col_index_from_longitide_latitude
        )
    ...
    def apply_transformation_to_band(self, band):
        ...
        if band.ndim == 2:
            subset_band = band[min_row : self._max_row, min_col : self._max_col]
        elif band.ndim == 3:
            subset_band = band[min_row : self._max_row, min_col : self._max_col, :]
        return subset_band
